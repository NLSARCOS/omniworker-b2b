...
export const metadata: Metadata = {
  title: "Automatización de Recursos Humanos — Flux Agent",
  description: "Delegá lo repetitivo de RRHH y enfocate en las personas. Selección automática, onboarding y gestión de candidatos. By Simplex Latam.",
  keywords: "automatización RRHH, selección candidatos automática, onboarding automatizado, reclutamiento inteligente LATAM",
  openGraph: {
    title: "Automatización de Recursos Humanos — Flux Agent",
    description: "Delegá lo repetitivo de RRHH y enfocate en las personas. Selección automática, onboarding y gestión de candidatos. By Simplex Latam.",
    url: "https://flux.simplex.lat/automatizacion-recursos-humanos",
    siteName: "Flux Agent",
    locale: "es_LA",
    type: "website",
  },
...
export default function Page() {
  const STATS = [{"num": "70%", "label": "Menos tiempo en screening de CVs"}, {"num": "3 días", "label": "De contratación a primer día productivo"}, {"num": "85%", "label": "De candidatos responden al contacto automático"}, {"num": "24/7", "label": "Comunicación con candidatos"}];
  const FEATURES = [{"icon": "📄", "name": "Filtro automático de CVs", "dept": "Reclutamiento"}, {"icon": "📅", "name": "Scheduling de entrevistas", "dept": "Coordinación"}, {"icon": "📧", "name": "Comunicaciones con candidatos", "dept": "Experiencia"}, {"icon": "📋", "name": "Evaluaciones iniciales", "dept": "Selección"}, {"icon": "🎓", "name": "Onboarding automatizado", "dept": "Integración"}, {"icon": "📊", "name": "Reportes de métricas RRHH", "dept": "Datos"}, {"icon": "🔗", "name": "Integración con tu ATS", "dept": "Sistemas"}, {"icon": "✏️", "name": "¿Otro proceso? Lo armamos", "dept": "Personalizado", "dark": true}];
  const STEPS = [{"n": "01", "title": "Definimos los perfiles", "desc": "Nos contás qué buscás en cada puesto y el asistente aprende a identificar candidatos ideales."}, {"n": "02", "title": "Conectamos tus canales", "desc": "Integramos con tu portal de empleo, correo y calendario para automatizar todo el flujo."}, {"n": "03", "title": "Filtra y contacta", "desc": "El asistente revisa CVs, preselecciona y contacta automáticamente. Tu equipo solo entrevista."}];
  const TESTIMONIALS = [{"quote": "Recibimos 400 CVs por puesto. Antes tardábamos 2 semanas en preseleccionar. Ahora el asistente lo hace en 4 horas.", "name": "Verónica López", "role": "Head de Talento · Globant Ecuador", "result": "↓ 90% tiempo en screening"}, {"quote": "El onboarding antes era caótico. Ahora el asistente envía todo el kit de bienvenida y el nuevo colaborador llega preparado.", "name": "Camilo Herrera", "role": "VP Personas · TechStaff Colombia", "result": "↑ Onboarding en 1 día"}, {"quote": "Nuestro time-to-hire bajó de 45 a 12 días. Los mejores candidatos ya no se nos van.", "name": "Isabel Molina", "role": "GERENTE DE RRHH · NuevaCorp México", "result": "↓ Time-to-hire 73%"}];
  const MARQUEE = ["Filtro de CVs", "Scheduling entrevistas", "Comunicaciones masivas", "Onboarding automático", "Seguimiento candidatos", "Evaluaciones iniciales", "Reportes RRHH", "Integración ATS"];
  const PROBLEMA_STATS = [{"num": "500+", "desc": "CVs recibe una empresa por puesto abierto en LATAM. Sin automatización, el 80% nunca se revisa."}, {"num": "23\nmin", "desc": "Tarda un reclutador en revisar un CV. Un asistente lo hace en segundos y evalúa consistencia."}, {"num": "5\ndías", "desc": "Tarda una empresa promedio en contactar al candidato ideal. El asistente lo hace en minutos."}];
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "Automatización de Recursos Humanos — Flux Agent",
          "description": "Delegá lo repetitivo de RRHH y enfocate en las personas. Selección automática, onboarding y gestión de candidatos. By Simplex Latam.",
      ...
      <div style={{ background: "var(--paper)", color: "var(--ink)", fontFamily: "'Inter', sans-serif", fontSize: 16, lineHeight: 1.65, WebkitFontSmoothing: "antialiased", backgroundImage: "repeating-linear-gradient(0deg, transparent 0, transparent 23px, rgba(0,0,0,0.022) 23px, rgba(0,0,0,0.022) 24px)" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 5vw 88px", display: "grid", gridTemplateColumns: "1fr 360px", gap: 80, alignItems: "start" }}>
          <div>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--neon-dim)", background: "var(--neon-pale)", padding: "8px 14px", display: "inline-block", marginBottom: 28, borderLeft: `3px solid var(--neon)` }}>
              RRHH automatizado · By Simplex Latam
            </div>
            <h1 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 144, "SOFT" 30, "WONK" 0', fontWeight: 500, fontSize: "clamp(52px, 6vw, 88px)", lineHeight: 0.93, letterSpacing: "-0.04em", color: "var(--ink)", marginBottom: 32 }}>Delegá lo repetitivo.<br /><em style={{ fontStyle: "italic", color: "var(--neon-dim)", fontVariationSettings: '"opsz" 144, "SOFT" 80' }}>Enfocate</em><br />en las personas.</h1>
            <p style={{ fontSize: 20, fontWeight: 400, lineHeight: 1.6, color: "var(--ink-soft)", maxWidth: 600, marginBottom: 48, borderLeft: `3px solid var(--rule)`, paddingLeft: 20 }}>
              Flux Agent automatiza las tareas operativas de Recursos Humanos: filtra CVs, programa entrevistas, envía comunicaciones y gestiona el onboarding para que tu equipo se enfoque en lo estratégico.
            </p>
        ...
        <section id="problema" style={{ background: "var(--ink)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--paper)", marginBottom: 20 }}>Tu equipo de RRHH<br /><em style={{ color: "var(--neon)", fontStyle: "italic" }}>no debería filtrar 500 CVs.</em></h2>
            <p style={{ ...{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }, color: "rgba(245,240,232,0.6)" }}>
              Por cada puesto abierto recibís cientos de CVs. Revisarlos manualmente toma días y los mejores candidatos se van con la competencia mientras esperan.
            </p>
        ...
        <section id="features" style={{ background: "var(--paper-warm)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--neon-dim)", marginBottom: 16, display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ color: "var(--muted)" }}>§</span>RRHH
            </div>
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--ink)", marginBottom: 20 }}>Automatizá todo el ciclo<br /><em style={{ color: "var(--neon-dim)", fontStyle: "italic" }}>del talento humano.</em></h2>
            <p style={{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }}>
              Desde la publicación de la vacante hasta el primer día del nuevo colaborador.
            </p>
