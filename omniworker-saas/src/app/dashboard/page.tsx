        ...
        <Section title="Descargas" id="actions">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16 }}>
            <div style={{ border: `1.5px solid var(--rule)`, borderRadius: 10, padding: 24, background: "var(--paper-warm)", transition: "all 0.15s ease" }}>
              ...
              <div style={{ fontSize: 13, color: "var(--muted)", margin: "0 0 16px", fontWeight: 400 }}>App nativa para macOS, Windows, Linux — v0.6.5</div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                <a
                  href="/api/downloads/omniworker-desktop-0.6.5-x64.dmg"
                  style={{
                ...
                <a
                  href="/api/downloads/omniworker-desktop-0.6.5-setup.exe"
                  style={{
                    display: "inline-flex", alignItems: "center", gap: 8,
                    padding: "8px 16px", fontSize: 13, fontWeight: 600,
                    background: "var(--ink)", color: "var(--paper)",
                ...
                <a
                  href="/api/downloads/omniworker-desktop-0.6.5.AppImage"
                  style={{
                    display: "inline-flex", alignItems: "center", gap: 8,
                    padding: "8px 16px", fontSize: 13, fontWeight: 600,
