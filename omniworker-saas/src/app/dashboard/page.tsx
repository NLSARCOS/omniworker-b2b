        ...
        <Section title="Descargas" id="actions">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16 }}>
            <div style={{ border: `1.5px solid var(--rule)`, borderRadius: 10, padding: 24, background: "var(--paper-warm)", transition: "all 0.15s ease" }}>
              ...
              <div style={{ fontSize: 13, color: "var(--muted)", margin: "0 0 16px", fontWeight: 400 }}>App nativa para macOS, Windows, Linux — macOS v0.5.7 · Windows/Linux v0.5.6</div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                <a
                  href="/api/downloads/omniworker-desktop-0.5.7-x64.dmg"
                  style={{
