...
export const metadata: Metadata = {
  title: "Seguimiento De Clientes Automático — Flux Agent",
  description: "Descubrí cómo seguimiento de clientes automático puede transformar tu empresa. Solución inteligente para automatizar procesos y escalar sin contratar. By Simplex Latam.",
  keywords: "seguimiento de clientes automático, automatización, IA, LATAM",
  openGraph: {
    title: "Seguimiento De Clientes Automático — Flux Agent",
    description: "Descubrí cómo seguimiento de clientes automático puede transformar tu empresa. Solución inteligente para automatizar procesos y escalar sin contratar. By Simplex Latam.",
    url: "https://flux.simplex.lat/seguimiento-de-clientes-automatico",
    siteName: "Flux Agent",
    locale: "es_LA",
    type: "website",
  },
...
const FEATURES = [["⚡", "Resultados en 14 días", "Implementación express"], ["🔗", "Integración total", "CRM, WhatsApp, y más"], ["🔄", "Escalado automático", "Crece sin límites"], ["🔒", "Seguridad empresarial", "Datos protegidos"]];
...
const STEPS = [{"n": "01", "title": "Diagnóstico gratuito", "desc": "Analizamos tu proceso de seguimiento de clientes automático y detectamos oportunidades."}, {"n": "02", "title": "Configuración express", "desc": "Implementamos la solución conectada a tus herramientas en 14 días."}, {"n": "03", "title": "Resultados medibles", "desc": "Monitoreá el impacto en tiempo real con soporte dedicado."}];
const TESTIMONIALS = [{"quote": "Implementar seguimiento de clientes automático con Flux Agent cambió nuestra operación. Ahorramos 40hs semanales.", "name": "María González", "role": "CEO · TechStart MX", "result": "↓ 40hs/semana"}, {"quote": "El ROI fue inmediato. En el primer mes ya habíamos recuperado la inversión.", "name": "Carlos Ruiz", "role": "Director · InnovateAR", "result": "↑ 300% ROI"}];
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "Seguimiento De Clientes Automático — Flux Agent",
          "description": "Descubrí cómo seguimiento de clientes automático puede transformar tu empresa. Solución inteligente para automatizar procesos y escalar sin contratar. By Simplex Latam.",
      ...
      <div style={{ background: "var(--paper)", color: "var(--ink)", fontFamily: "'Inter', sans-serif", fontSize: 16, lineHeight: 1.65 }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 5vw 88px", display: "grid", gridTemplateColumns: "1fr 360px", gap: 80, alignItems: "start" }}>
          <div>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--neon-dim)", background: "var(--neon-pale)", padding: "8px 14px", display: "inline-block", marginBottom: 28, borderLeft: `3px solid var(--neon)` }}>
              Seguimiento De Clientes Automático · By Simplex Latam
            </div>
            <h1 style={{ fontFamily: "'Fraunces', serif", fontWeight: 500, fontSize: "clamp(52px, 6vw, 88px)", lineHeight: 0.93, letterSpacing: "-0.04em", color: "var(--ink)", marginBottom: 32 }}>Seguimiento De Clientes Automático</h1>
            <p style={{ fontSize: 20, fontWeight: 400, lineHeight: 1.6, color: "var(--ink-soft)", maxWidth: 600, marginBottom: 48, borderLeft: `3px solid var(--rule)`, paddingLeft: 20 }}>
              Descubrí cómo seguimiento de clientes automático puede transformar tu empresa. Solución inteligente para automatizar procesos y escalar sin contratar. By Simplex Latam.
            </p>
        ...
        <div style={{ background: "var(--ink)", color: "var(--paper)", padding: "80px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 500, lineHeight: 1.1, marginBottom: 60, maxWidth: 900 }}>Todo lo que necesitás para automatizar seguimiento de clientes automático.</h2>
        ...
        <div style={{ background: "var(--neon)", padding: "80px 5vw", textAlign: "center" }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: "clamp(36px, 5vw, 64px)", fontWeight: 600, lineHeight: 1.05, marginBottom: 24, color: "var(--paper)" }}>¿Listo para automatizar seguimiento de clientes automático?</h2>
