...
const FEATURES = [["🧠", "IA avanzada", "Procesamiento inteligente"], ["📱", "Multi-canal", "Web, WhatsApp, mobile"], ["🔗", "Integración total", "CRM, WhatsApp, y más"], ["🔒", "Seguridad empresarial", "Datos protegidos"], ["⚡", "Resultados en 14 días", "Implementación express"], ["🎯", "ROI garantizado", "800% en el primer trimestre"]];
