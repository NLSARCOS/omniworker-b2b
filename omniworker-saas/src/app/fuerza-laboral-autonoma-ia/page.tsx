...
const FEATURES = [["🔒", "Seguridad empresarial", "Datos protegidos"], ["🎯", "ROI garantizado", "800% en el primer trimestre"], ["🧠", "IA avanzada", "Procesamiento inteligente"], ["📊", "Analytics en tiempo real", "Métricas que importan"], ["🔄", "Escalado automático", "Crece sin límites"], ["🔗", "Integración total", "CRM, WhatsApp, y más"]];
