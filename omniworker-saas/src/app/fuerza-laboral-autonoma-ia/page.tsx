...
const FEATURES = [["🧠", "IA avanzada", "Procesamiento inteligente"], ["🔄", "Escalado automático", "Crece sin límites"], ["📊", "Analytics en tiempo real", "Métricas que importan"], ["⚡", "Resultados en 14 días", "Implementación express"], ["🎯", "ROI garantizado", "800% en el primer trimestre"]];
