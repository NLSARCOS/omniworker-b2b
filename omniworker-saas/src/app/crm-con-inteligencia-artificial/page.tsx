...
const FEATURES = [["📱", "Multi-canal", "Web, WhatsApp, mobile"], ["🎯", "ROI garantizado", "800% en el primer trimestre"], ["📊", "Analytics en tiempo real", "Métricas que importan"], ["🧠", "IA avanzada", "Procesamiento inteligente"]];
