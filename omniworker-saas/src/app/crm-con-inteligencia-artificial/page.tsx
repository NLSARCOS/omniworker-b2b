...
const FEATURES = [["🔒", "Seguridad empresarial", "Datos protegidos"], ["🔄", "Escalado automático", "Crece sin límites"], ["🎯", "ROI garantizado", "800% en el primer trimestre"], ["📱", "Multi-canal", "Web, WhatsApp, mobile"]];
