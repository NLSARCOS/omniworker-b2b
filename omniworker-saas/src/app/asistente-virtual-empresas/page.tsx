...
export const metadata: Metadata = {
  title: "Asistente Virtual para Empresas — Flux Agent",
  description: "Contratá un asistente virtual que atiende clientes, gestiona tareas y automatiza procesos para tu empresa. Sin nómina, sin contratos. By Simplex Latam.",
  keywords: "asistente virtual empresas, asistente digital negocio, automatizar atención clientes, asistente virtual LATAM",
  openGraph: {
    title: "Asistente Virtual para Empresas — Flux Agent",
    description: "Contratá un asistente virtual que atiende clientes, gestiona tareas y automatiza procesos para tu empresa. Sin nómina, sin contratos. By Simplex Latam.",
    url: "https://flux.simplex.lat/asistente-virtual-empresas",
    siteName: "Flux Agent",
    locale: "es_LA",
    type: "website",
  },
...
export default function Page() {
  const STATS = [{"num": "800%", "label": "Retorno sobre inversión en 90 días"}, {"num": "73%", "label": "Del día de tu equipo va en tareas repetitivas"}, {"num": "14", "label": "Días para tener tu asistente funcionando"}, {"num": "24/7", "label": "Trabaja sin pausas ni vacaciones"}];
  const FEATURES = [{"icon": "💬", "name": "Atención por WhatsApp 24/7", "dept": "Servicio al cliente"}, {"icon": "🎯", "name": "Seguimiento de prospectos", "dept": "Ventas"}, {"icon": "📊", "name": "Reportes automáticos", "dept": "Operaciones"}, {"icon": "📅", "name": "Gestión de citas", "dept": "Servicios"}, {"icon": "💰", "name": "Recordatorios de pago", "dept": "Finanzas"}, {"icon": "👥", "name": "Filtro de candidatos", "dept": "Recursos humanos"}, {"icon": "🔔", "name": "Alertas del negocio", "dept": "Dirección"}, {"icon": "✏️", "name": "¿Otro proceso? Lo armamos", "dept": "Personalizado", "dark": true}];
  const STEPS = [{"n": "01", "title": "Contás qué necesitás", "desc": "Explicás qué tarea querés delegar. No hace falta ser técnico."}, {"n": "02", "title": "Lo conectamos", "desc": "Integramos con WhatsApp, CRM, calendario y tus herramientas habituales."}, {"n": "03", "title": "Trabaja solo", "desc": "El asistente funciona 24/7. Vos solo revisás los resultados."}];
  const TESTIMONIALS = [{"quote": "Pusimos el asistente a atender WhatsApp y redujo el tiempo de respuesta un 89%. Ahora el equipo se enfoca en casos complejos.", "name": "Andrea Molina", "role": "Gerente de Servicio · TechServ Ecuador", "result": "↓ 89% tiempo de respuesta"}, {"quote": "Lo configuramos para seguimiento de prospectos. En el primer mes recuperamos USD 8,000 en oportunidades que antes perdíamos.", "name": "Roberto Fuentes", "role": "Director Comercial · Andina Solutions", "result": "↑ USD 8,000 recuperados"}, {"quote": "En 10 días tenía mi asistente funcionando y mis reportes llegan cada lunes a las 8am. Sin complicaciones.", "name": "Lucía Vega", "role": "COO · Merkato Colombia", "result": "↑ 340 horas recuperadas"}];
  const MARQUEE = ["Atención WhatsApp", "Seguimiento CRM", "Reportes automáticos", "Gestión de citas", "Recordatorios de cobro", "Calificación de leads", "Soporte multiidioma", "Integración software"];
  const PROBLEMA_STATS = [{"num": "USD\n2,500", "desc": "Costo mensual promedio de un colaborador en LATAM. El asistente hace el mismo trabajo por una fracción."}, {"num": "4\nmeses", "desc": "Tiempo hasta que una persona nueva es productiva. El asistente funciona en 14 días."}, {"num": "35%", "desc": "De los equipos operativos rota cada año. El asistente digital no renuncia ni se enferma."}];
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "Asistente Virtual para Empresas — Flux Agent",
          "description": "Contratá un asistente virtual que atiende clientes, gestiona tareas y automatiza procesos para tu empresa. Sin nómina, sin contratos. By Simplex Latam.",
      ...
      <div style={{ background: "var(--paper)", color: "var(--ink)", fontFamily: "'Inter', sans-serif", fontSize: 16, lineHeight: 1.65, WebkitFontSmoothing: "antialiased", backgroundImage: "repeating-linear-gradient(0deg, transparent 0, transparent 23px, rgba(0,0,0,0.022) 23px, rgba(0,0,0,0.022) 24px)" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 5vw 88px", display: "grid", gridTemplateColumns: "1fr 360px", gap: 80, alignItems: "start" }}>
          <div>
            ...
            <h1 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 144, "SOFT" 30, "WONK" 0', fontWeight: 500, fontSize: "clamp(52px, 6vw, 88px)", lineHeight: 0.93, letterSpacing: "-0.04em", color: "var(--ink)", marginBottom: 32 }}>El asistente<br />que{" "}<em style={{ fontStyle: "italic", color: "var(--neon-dim)", fontVariationSettings: '"opsz" 144, "SOFT" 80' }}>virtual</em><br />que tu empresa necesita.</h1>
            <p style={{ fontSize: 20, fontWeight: 400, lineHeight: 1.6, color: "var(--ink-soft)", maxWidth: 600, marginBottom: 48, borderLeft: `3px solid var(--rule)`, paddingLeft: 20 }}>
              Flux Agent pone a trabajar un asistente digital en tu empresa que atiende clientes por WhatsApp, sigue prospectos de ventas y gestiona tareas repetitivas — las 24 horas, sin nómina adicional.
            </p>
            <div style={{ display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" }}>
              <Link href="/register" style={{ background: "var(--neon)", color: "var(--ink)", padding: "15px 32px", fontFamily: "'Inter', sans-serif", fontSize: 14, fontWeight: 700, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 8, borderRadius: 6 }}>
                Configurar mi asistente virtual →
              </Link>
        ...
        <section id="problema" style={{ background: "var(--ink)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--paper)", marginBottom: 20 }}>Contratar personas para tareas<br />repetitivas <em style={{ color: "var(--neon)", fontStyle: "italic" }}>no escala.</em></h2>
            <p style={{ ...{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }, color: "rgba(245,240,232,0.6)" }}>
              Cada vez que necesitás más capacidad, contratar toma semanas y cuesta miles. El asistente virtual de Flux Agent se configura en días y escala sin límite.
            </p>
        ...
        <section id="features" style={{ background: "var(--paper-warm)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--neon-dim)", marginBottom: 16, display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ color: "var(--muted)" }}>§</span>Soluciones
            </div>
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--ink)", marginBottom: 20 }}>Todo lo que tu negocio<br /><em style={{ color: "var(--neon-dim)", fontStyle: "italic" }}>necesita automatizar.</em></h2>
            <p style={{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }}>
              Cada asistente se configura para tu proceso específico. Sin plantillas genéricas.
            </p>
