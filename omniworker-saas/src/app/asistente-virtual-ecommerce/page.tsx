...
export const metadata: Metadata = {
  title: "Asistente Virtual para E-commerce — Flux Agent",
  description: "Recuperá las ventas que estás perdiendo. Carritos abandonados, consultas de productos y recomendaciones automáticas. By Simplex Latam.",
  keywords: "asistente virtual e-commerce, recuperación carritos abandonados, chatbot tienda online, automatización ventas online LATAM",
  openGraph: {
    title: "Asistente Virtual para E-commerce — Flux Agent",
    description: "Recuperá las ventas que estás perdiendo. Carritos abandonados, consultas de productos y recomendaciones automáticas. By Simplex Latam.",
    url: "https://flux.simplex.lat/asistente-virtual-ecommerce",
    siteName: "Flux Agent",
    locale: "es_LA",
    type: "website",
  },
...
export default function Page() {
  const STATS = [{"num": "70%", "label": "De carritos se abandonan sin intervención"}, {"num": "18%", "label": "De ventas recuperadas con seguimiento automático"}, {"num": "< 2min", "label": "Tiempo de respuesta a consultas"}, {"num": "24/7", "label": "Atención continua"}];
  const FEATURES = [{"icon": "🛒", "name": "Recuperación de carritos abandonados", "dept": "Conversión"}, {"icon": "💬", "name": "Consultas de productos en tiempo real", "dept": "Atención"}, {"icon": "🎯", "name": "Recomendaciones personalizadas", "dept": "Cross-sell"}, {"icon": "📦", "name": "Seguimiento de envíos", "dept": "Post-venta"}, {"icon": "⭐", "name": "Solicitud de reviews post-compra", "dept": "Reputación"}, {"icon": "🏷️", "name": "Promociones automáticas", "dept": "Marketing"}, {"icon": "🔗", "name": "Integración Shopify/WooCommerce", "dept": "Plataforma"}, {"icon": "✏️", "name": "¿Otra necesidad? Lo configuramos", "dept": "Personalizado", "dark": true}];
  const STEPS = [{"n": "01", "title": "Conectamos tu tienda", "desc": "Integramos el asistente con Shopify, WooCommerce o tu plataforma. Detecta carritos abandonados al instante."}, {"n": "02", "title": "Configuramos las campañas", "desc": "Definimos mensajes de recuperación, consultas de productos y flujo de recomendaciones."}, {"n": "03", "title": "Vende mientras dormís", "desc": "El asistente recupera ventas, responde consultas y envía recomendaciones 24/7."}];
  const TESTIMONIALS = [{"quote": "Recuperamos el 18% de los carritos abandonados en el primer mes. Eso son USD 12,000 extra que antes perdíamos.", "name": "Sofía Delgado", "role": "CEO · ModaClick Ecuador", "result": "↑ 18% recuperación carritos"}, {"quote": "Las consultas de productos por WhatsApp se responden en segundos ahora. La conversión subió 25%.", "name": "Diego Montoya", "role": "Director E-commerce · RetailPro Colombia", "result": "↑ 25% conversión"}, {"quote": "El asistente cruza datos de compras anteriores y recomienda productos. El ticket promedio subió 30%.", "name": "Ana María Ruiz", "role": "CMO · TiendaLat México", "result": "↑ 30% ticket promedio"}];
  const MARQUEE = ["Recuperación carritos", "Consultas productos", "Recomendaciones", "Seguimiento envíos", "Promociones automáticas", "Reviews post-compra", "Cross-selling", "Integración Shopify"];
  const PROBLEMA_STATS = [{"num": "70%", "desc": "De los carritos se abandonan. El principal motivo es una duda sin resolver en el momento de la compra."}, {"num": "63%", "desc": "De las recuperaciones ocurren cuando el cliente recibe un mensaje dentro de la primera hora."}, {"num": "USD\\n8K", "desc": "De ventas perdidas al mes tiene una tienda promedio en LATAM por carritos abandonados sin seguimiento."}];
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "Asistente Virtual para E-commerce — Flux Agent",
          "description": "Recuperá las ventas que estás perdiendo. Carritos abandonados, consultas de productos y recomendaciones automáticas. By Simplex Latam.",
      ...
      <div style={{ background: "var(--paper)", color: "var(--ink)", fontFamily: "'Inter', sans-serif", fontSize: 16, lineHeight: 1.65, WebkitFontSmoothing: "antialiased", backgroundImage: "repeating-linear-gradient(0deg, transparent 0, transparent 23px, rgba(0,0,0,0.022) 23px, rgba(0,0,0,0.022) 24px)" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 5vw 88px", display: "grid", gridTemplateColumns: "1fr 360px", gap: 80, alignItems: "start" }}>
          <div>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--neon-dim)", background: "var(--neon-pale)", padding: "8px 14px", display: "inline-block", marginBottom: 28, borderLeft: `3px solid var(--neon)` }}>
              E-commerce · By Simplex Latam
            </div>
            <h1 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 144, "SOFT" 30, "WONK" 0', fontWeight: 500, fontSize: "clamp(52px, 6vw, 88px)", lineHeight: 0.93, letterSpacing: "-0.04em", color: "var(--ink)", marginBottom: 32 }}>Recuperá las ventas<br />que{" "}<em style={{ fontStyle: "italic", color: "var(--neon-dim)", fontVariationSettings: '"opsz" 144, "SOFT" 80' }}>estás perdiendo.</em></h1>
            <p style={{ fontSize: 20, fontWeight: 400, lineHeight: 1.6, color: "var(--ink-soft)", maxWidth: 600, marginBottom: 48, borderLeft: `3px solid var(--rule)`, paddingLeft: 20 }}>
              Flux Agent conecta un asistente digital a tu tienda online que recupera carritos abandonados, resuelve consultas de productos en tiempo real y envía recomendaciones personalizadas.
            </p>
        ...
        <section id="problema" style={{ background: "var(--ink)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--paper)", marginBottom: 20 }}>El 70% de los carritos<br /><em style={{ color: "var(--neon)", fontStyle: "italic" }}>se abandonan.</em><br />Y nadie hace nada.</h2>
            <p style={{ ...{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }, color: "rgba(245,240,232,0.6)" }}>
              Los clientes llenan el carrito, dudan, y se van. Sin un seguimiento inmediato, esa venta se pierde para siempre. Un mensaje oportuno puede cambiar todo.
            </p>
        ...
        <section id="features" style={{ background: "var(--paper-warm)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--neon-dim)", marginBottom: 16, display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ color: "var(--muted)" }}>§</span>E-commerce
            </div>
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--ink)", marginBottom: 20 }}>Tu tienda,<br /><em style={{ color: "var(--neon-dim)", fontStyle: "italic" }}>con vendedor 24/7.</em></h2>
            <p style={{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }}>
              Desde la consulta del producto hasta la recompra. Todo automatizado.
            </p>
