...
const FEATURES = [["🔄", "Escalado automático", "Crece sin límites"], ["🔗", "Integración total", "CRM, WhatsApp, y más"], ["⚡", "Resultados en 14 días", "Implementación express"], ["📊", "Analytics en tiempo real", "Métricas que importan"]];
