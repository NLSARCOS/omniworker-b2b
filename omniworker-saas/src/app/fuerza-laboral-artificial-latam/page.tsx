...
const FEATURES = [["⚡", "Resultados en 14 días", "Implementación express"], ["📊", "Analytics en tiempo real", "Métricas que importan"], ["📱", "Multi-canal", "Web, WhatsApp, mobile"], ["🔒", "Seguridad empresarial", "Datos protegidos"]];
