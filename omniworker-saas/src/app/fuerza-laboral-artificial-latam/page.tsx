...
const FEATURES = [["📊", "Analytics en tiempo real", "Métricas que importan"], ["🔒", "Seguridad empresarial", "Datos protegidos"], ["⚡", "Resultados en 14 días", "Implementación express"], ["🧠", "IA avanzada", "Procesamiento inteligente"], ["🔗", "Integración total", "CRM, WhatsApp, y más"]];
