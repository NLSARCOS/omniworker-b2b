...
const FEATURES = [["🧠", "IA avanzada", "Procesamiento inteligente"], ["🔄", "Escalado automático", "Crece sin límites"], ["⚡", "Resultados en 14 días", "Implementación express"], ["📊", "Analytics en tiempo real", "Métricas que importan"]];
