...
export const metadata: Metadata = {
  title: "Chatbot Empresarial — Flux Agent",
  description: "Un chatbot que entiende tu negocio, resuelve consultas y se conecta a tus sistemas. Para empresas que quieren escalar sin contratar. By Simplex Latam.",
  keywords: "chatbot empresarial, chatbot para empresas, chatbot inteligente, chatbot atención clientes LATAM",
  openGraph: {
    title: "Chatbot Empresarial — Flux Agent",
    description: "Un chatbot que entiende tu negocio, resuelve consultas y se conecta a tus sistemas. Para empresas que quieren escalar sin contratar. By Simplex Latam.",
    url: "https://flux.simplex.lat/chatbot-empresarial",
    siteName: "Flux Agent",
    locale: "es_LA",
    type: "website",
  },
...
export default function Page() {
  const STATS = [{"num": "85%", "label": "De consultas resueltas sin humano"}, {"num": "24/7", "label": "Disponibilidad total"}, {"num": "1/10", "label": "Del costo de un agente humano"}, {"num": "< 30s", "label": "Tiempo de respuesta promedio"}];
  const FEATURES = [{"icon": "🧠", "name": "Comprensión contextual", "dept": "IA"}, {"icon": "🔗", "name": "Integración con tu CRM", "dept": "Ventas"}, {"icon": "📱", "name": "WhatsApp, web y más", "dept": "Multi-canal"}, {"icon": "📊", "name": "Analytics de conversaciones", "dept": "Datos"}, {"icon": "🎯", "name": "Calificación de oportunidades", "dept": "Comercial"}, {"icon": "🔄", "name": "Escalado a equipo humano", "dept": "Operaciones"}, {"icon": "📚", "name": "Base de conocimiento dinámica", "dept": "Contenido"}, {"icon": "✏️", "name": "¿Otra necesidad? Lo creamos", "dept": "Personalizado", "dark": true}];
  const STEPS = [{"n": "01", "title": "Cargamos tu información", "desc": "Nos compartís catálogos, FAQs, políticas y procesos. El chatbot aprende todo sobre tu negocio."}, {"n": "02", "title": "Lo conectamos", "desc": "Integramos con WhatsApp, tu sitio web, CRM y herramientas. Un solo bot, todos los canales."}, {"n": "03", "title": "Resuelve y aprende", "desc": "Atiende consultas, califica leads y escala lo complejo. Cada conversación lo hace mejor."}];
  const TESTIMONIALS = [{"quote": "Nuestro chatbot anterior era un desastre. Este entiende el contexto de nuestra empresa y resuelve el 85% de las consultas solo.", "name": "Javier Castillo", "role": "CTO · Moneda Digital México", "result": "↓ 85% consultas sin humano"}, {"quote": "Lo conectamos al CRM y ahora cada lead que llega por chat se califica automáticamente.", "name": "Gabriela Torres", "role": "Directora Comercial · Saldo.mx", "result": "↑ 3x leads calificados"}, {"quote": "Implementamos en 10 días. El primer mes ya habíamos ahorrado USD 4,000 en soporte.", "name": "René Vargas", "role": "COO · Koba Ecuador", "result": "↓ USD 4,000/mes en soporte"}];
  const MARQUEE = ["Comprensión contextual", "Integración CRM", "Multi-canal", "Aprendizaje continuo", "Escalado automático", "Analytics avanzados", "Personalización", "Respuestas inteligentes"];
  const PROBLEMA_STATS = [{"num": "67%", "desc": "De los clientes abandona cuando el chatbot no entiende su consulta. Un chatbot inteligente revierte esta tendencia."}, {"num": "3\\nintents", "desc": "Es lo que tolera un usuario antes de pedir hablar con una persona. Si tu bot no resuelve en 3 intentos, pierdes."}, {"num": "USD\\n8K", "desc": "Ahorrado mensualmente por empresas que automatizan su primer nivel de soporte con un chatbot entrenado."}];
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "Chatbot Empresarial — Flux Agent",
          "description": "Un chatbot que entiende tu negocio, resuelve consultas y se conecta a tus sistemas. Para empresas que quieren escalar sin contratar. By Simplex Latam.",
      ...
      <div style={{ background: "var(--paper)", color: "var(--ink)", fontFamily: "'Inter', sans-serif", fontSize: 16, lineHeight: 1.65, WebkitFontSmoothing: "antialiased", backgroundImage: "repeating-linear-gradient(0deg, transparent 0, transparent 23px, rgba(0,0,0,0.022) 23px, rgba(0,0,0,0.022) 24px)" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 5vw 88px", display: "grid", gridTemplateColumns: "1fr 360px", gap: 80, alignItems: "start" }}>
          <div>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--neon-dim)", background: "var(--neon-pale)", padding: "8px 14px", display: "inline-block", marginBottom: 28, borderLeft: `3px solid var(--neon)` }}>
              Chatbot inteligente · By Simplex Latam
            </div>
            <h1 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 144, "SOFT" 30, "WONK" 0', fontWeight: 500, fontSize: "clamp(52px, 6vw, 88px)", lineHeight: 0.93, letterSpacing: "-0.04em", color: "var(--ink)", marginBottom: 32 }}>Un chatbot que<br /><em style={{ fontStyle: "italic", color: "var(--neon-dim)", fontVariationSettings: '"opsz" 144, "SOFT" 80' }}>entiende</em><br />tu negocio.</h1>
            <p style={{ fontSize: 20, fontWeight: 400, lineHeight: 1.6, color: "var(--ink-soft)", maxWidth: 600, marginBottom: 48, borderLeft: `3px solid var(--rule)`, paddingLeft: 20 }}>
              Flux Agent crea un chatbot entrenado con la información de tu empresa. Resuelve consultas, califica oportunidades y trabaja conectado a tu CRM, WhatsApp y sitio web.
            </p>
        ...
        <section id="problema" style={{ background: "var(--ink)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--paper)", marginBottom: 20 }}>Los chatbots genéricos<br /><em style={{ color: "var(--neon)", fontStyle: "italic" }}>frustran a tus clientes.</em></h2>
            <p style={{ ...{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }, color: "rgba(245,240,232,0.6)" }}>
              La mayoría de chatbots no entienden el contexto de tu negocio. Responden mal, frustan al cliente y terminan siendo ignorados. Flux Agent entrena un chatbot con TU información.
            </p>
        ...
        <section id="features" style={{ background: "var(--paper-warm)", padding: "96px 5vw" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontVariationSettings: '"opsz" 80, "SOFT" 30', fontWeight: 500, fontSize: "clamp(34px, 4vw, 54px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--ink)", marginBottom: 20 }}>Un chatbot que<br /><em style={{ color: "var(--neon-dim)", fontStyle: "italic" }}>trabaja como tu mejor agente.</em></h2>
            <p style={{ fontSize: 18, fontWeight: 400, color: "var(--muted)", maxWidth: 680, lineHeight: 1.65, marginBottom: 56 }}>
              No es un bot de preguntas frecuentes. Es un asistente que entiende contexto, aprende y actúa.
            </p>
