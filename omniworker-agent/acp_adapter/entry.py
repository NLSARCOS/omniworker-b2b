...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="omniworker-acp",
        description="Run OmniWorker Agent as an ACP stdio server.",
    )
    parser.add_argument("--version", action="store_true", help="Print OmniWorker version and exit")
    parser.add_argument(
        "--check",
        action="store_true",
