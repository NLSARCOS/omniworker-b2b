...
const STORAGE_KEY = "flux-agent-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `flux-agent_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "flux-agent-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-flux-agent-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-flux-agent-theme-font", "true");
