...
const STORAGE_KEY = "omniworker-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `omniworker_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "omniworker-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-omniworker-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-omniworker-theme-font", "true");
