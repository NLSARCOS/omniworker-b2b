 ...
 *
 * Plugins call window.__OMNIWORKER_PLUGINS__.register(name, Component)
...
declare global {
  interface Window {
    __OMNIWORKER_PLUGIN_SDK__: unknown;
    __OMNIWORKER_PLUGINS__: {
...
export function exposePluginSDK() {
  window.__OMNIWORKER_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__OMNIWORKER_PLUGIN_SDK__ = {
