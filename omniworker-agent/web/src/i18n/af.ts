...
export const af: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk OmniWorker-inproppe op (`flux-agent plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.flux-agent/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.flux-agent/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.flux-agent/skills/",
