...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateOmniWorker: "Update OmniWorker",
    updatingOmniWorker: "Updating OmniWorker…",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible OmniWorker badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning OmniWorker session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run OmniWorker more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once OmniWorker sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "OmniWorker is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
