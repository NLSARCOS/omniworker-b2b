...
export const es: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de OmniWorker (equivalente a `flux-agent plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.flux-agent/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.flux-agent/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.flux-agent/skills/",
