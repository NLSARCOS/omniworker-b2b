...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateOmniWorker: "OmniWorker'i Güncelle",
    updatingOmniWorker: "OmniWorker güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "OmniWorker eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`omniworker plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.omniworker/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.omniworker/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.omniworker/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk OmniWorker rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "OmniWorker oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "OmniWorker'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. OmniWorker ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "OmniWorker yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
