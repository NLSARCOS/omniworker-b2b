...
export const tr: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "OmniWorker eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`flux-agent plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.flux-agent/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.flux-agent/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.flux-agent/skills/ adresinden yüklenir",
