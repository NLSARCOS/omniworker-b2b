...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateOmniWorker: "OmniWorker aktualisieren",
    updatingOmniWorker: "OmniWorker wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "OmniWorker-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `omniworker plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.omniworker/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.omniworker/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.omniworker/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare OmniWorker-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "OmniWorker-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze OmniWorker mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald OmniWorker ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "OmniWorker scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
