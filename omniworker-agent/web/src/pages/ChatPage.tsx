...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      // let the inner OmniWorker TUI own transcript history/scroll behavior.
    ...
    // OmniWorker TUI own transcript scrolling.
    //
    ...
    // forwarding them into OmniWorker. Keyboard input, paste, and resize still
    // behave normally.
