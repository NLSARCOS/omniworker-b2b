...
# Must match flux-agent_cli.runtime_provider.RUNTIME_PROVIDER_TYPE_CUSTOM.
...
def _load_config() -> dict:
    ...
    to the persistent config (flux-agent_cli/config.py load_config()) so that
