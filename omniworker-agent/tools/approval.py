...
def _is_gateway_approval_context() -> bool:
    ...
    """
    if env_var_enabled("OMNIWORKER_CRON_SESSION"):
        return False
    if env_var_enabled("OMNIWORKER_GATEWAY_SESSION"):
        return True
...
def check_dangerous_command(command: str, env_type: str,
    ...
    is_cli = env_var_enabled("OMNIWORKER_INTERACTIVE")
    ...
    if is_gateway or env_var_enabled("OMNIWORKER_EXEC_ASK"):
...
def check_all_command_guards(command: str, env_type: str,
    ...
    is_cli = env_var_enabled("OMNIWORKER_INTERACTIVE")
    is_gateway = _is_gateway_approval_context()
    is_ask = env_var_enabled("OMNIWORKER_EXEC_ASK")
