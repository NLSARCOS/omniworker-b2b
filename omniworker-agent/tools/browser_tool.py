...
def _lightpanda_fallback_reason(engine: str, command: str, result: Dict[str, Any]) -> Optional[str]:
    ...
    the fallback result so CLI/TUI/gateway users can see when OmniWorker silently
...
def _run_chrome_fallback_command(
    ...
    def _run_tmp(cmd: str, cmd_args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            #   in the OmniWorker CLI where sys.stdout and sys.stderr both report
...
def _find_agent_browser() -> str:
    ...
    Checks in order: current PATH, Homebrew/common bin dirs, OmniWorker-managed
    ...
    # Build an extended search PATH including OmniWorker-managed Node, macOS
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        recordings_dir = omniworker_home / "browser_recordings"
