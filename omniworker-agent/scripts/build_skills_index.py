#!/usr/bin/env python3
"""Build the OmniWorker Skills Index — a centralized JSON catalog of all skills.
...
`omniworker skills search/install` can use it without hitting the GitHub API.
...
# Ensure OMNIWORKER_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building OmniWorker Skills Index...", flush=True)
