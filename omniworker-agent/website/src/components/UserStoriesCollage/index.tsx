  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the OmniWorker Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use OmniWorker &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        ...
        <a href="https://discord.gg/OmniWorker" target="_blank" rel="noopener noreferrer">
