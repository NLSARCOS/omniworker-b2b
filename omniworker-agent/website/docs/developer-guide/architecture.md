...
sidebar_position: 1
title: "Architecture"
description: "Flux Agent Agent internals — major subsystems, execution paths, data flow, and where to read next"
---

# Architecture

This page is the top-level map of Flux Agent Agent internals. Use it to orient yourself in the codebase, then dive into subsystem-specific docs for implementation details.
...
Exposes Flux Agent as an editor-native agent over stdio/JSON-RPC for VS Code, Zed, and JetBrains.
