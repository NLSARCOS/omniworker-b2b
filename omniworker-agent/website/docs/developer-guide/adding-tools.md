...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to OmniWorker Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in OmniWorker tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying OmniWorker core, use the plugin route instead:

- [Plugins](/docs/user-guide/features/plugins)
- [Build a OmniWorker Plugin](/docs/guides/build-a-omniworker-plugin)
