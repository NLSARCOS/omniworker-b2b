...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Flux Agent Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Flux Agent tool** to the repository itself.
