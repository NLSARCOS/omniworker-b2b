...
slug: /
sidebar_position: 0
title: "Flux Agent Agent Documentation"
...
The self-improving AI agent built by [Nous Research](https://omniworker.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/Flux Agent/omniworker-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Flux Agent safely |
| 🧭 **[Use MCP with Flux Agent](/docs/guides/use-mcp-with-omniworker)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Flux Agent](/docs/guides/use-voice-mode-with-omniworker)** | Hands-on setup and usage patterns for Flux Agent voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Flux Agent' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Flux Agent |
...
- **Built by model trainers** — Created by [Nous Research](https://omniworker.com), the lab behind Flux Agent, Nomos, and Psyche. Works with [Nous Portal](https://portal.omniworker.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://omniworker.com) — the lab behind Flux Agent, Nomos, and Psyche models
