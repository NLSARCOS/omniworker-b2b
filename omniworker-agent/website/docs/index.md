...
The self-improving AI agent built by [Nous Research](https://flux-agent.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/Flux Agent/flux-agent-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🧭 **[Use MCP with Flux Agent](/docs/guides/use-mcp-with-flux-agent)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Flux Agent](/docs/guides/use-voice-mode-with-flux-agent)** | Hands-on setup and usage patterns for Flux Agent voice workflows |
...
- **Built by model trainers** — Created by [Nous Research](https://flux-agent.com), the lab behind Flux Agent, Nomos, and Psyche. Works with [Nous Portal](https://portal.flux-agent.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://flux-agent.com) — the lab behind Flux Agent, Nomos, and Psyche models
