...
| [`omniworker-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-omniworker-agent) | Configure, extend, or contribute to Flux Agent Agent. | `autonomous-ai-agents/omniworker-agent` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-omniworker-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-omniworker-tui-commands) | Debug Flux Agent TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-omniworker-tui-commands` |
