...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  Flux Agent Agent  ──▶  GitHub API  ──▶  Review     │
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to Flux Agent instantly when PRs are opened or updated.
:::
...
Still in the chat, ask Flux Agent to review a real PR:
...
This is what makes the reviewer actually useful. Start a session and teach Flux Agent your team's standards:
...
2. Teach Flux Agent your conventions via memory (Step 4)
