...
Flux Agent Agent can drive your Mac's desktop — clicking, typing, scrolling,
...
Flux Agent applies multi-layer guardrails:
...
Screenshots are expensive. Flux Agent applies four layers of optimisation:
