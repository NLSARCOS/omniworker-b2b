...
description: "How Flux Agent Agent remembers across sessions — MEMORY.md, USER.md, and session search"
---

# Persistent Memory

Flux Agent Agent has bounded, curated memory that persists across sessions. This lets it remember your preferences, your projects, your environment, and things it has learned.
...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, Flux Agent ships with 8 external memory provider plugins — including Honcho, OpenViking, Mem0, Hindsight, Holographic, RetainDB, ByteRover, and Supermemory.
