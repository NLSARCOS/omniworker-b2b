...
description: "How OmniWorker Agent remembers across sessions — MEMORY.md, USER.md, and session search"
---

# Persistent Memory

OmniWorker Agent has bounded, curated memory that persists across sessions. This lets it remember your preferences, your projects, your environment, and things it has learned.
...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, OmniWorker ships with 8 external memory provider plugins — including Honcho, OpenViking, Mem0, Hindsight, Holographic, RetainDB, ByteRover, and Supermemory.
