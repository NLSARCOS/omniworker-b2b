...
| | |
|---|---|
| Source | Optional — install with `omniworker skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"OmniWorker","productType":"Apparel","tags":["test"]}}'
```
