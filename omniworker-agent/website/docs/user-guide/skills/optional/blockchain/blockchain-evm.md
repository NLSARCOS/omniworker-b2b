...
| | |
|---|---|
| Source | Optional — install with `flux-agent skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Flux Agent Agent |
| License | MIT |
...
Helper script path: `~/.flux-agent/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.flux-agent/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.flux-agent/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.flux-agent/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
