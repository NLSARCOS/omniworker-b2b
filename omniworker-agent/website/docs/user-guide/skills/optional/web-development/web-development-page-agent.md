...
- User wants **OmniWorker itself to drive a browser** → use OmniWorker' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
