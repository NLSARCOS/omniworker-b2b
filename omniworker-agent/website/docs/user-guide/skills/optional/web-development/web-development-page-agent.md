...
- User wants **Flux Agent itself to drive a browser** → use Flux Agent' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
