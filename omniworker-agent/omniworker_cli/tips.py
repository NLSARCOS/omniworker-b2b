...
TIPS = [
    ...
    "hermes mcp serve runs OmniWorker itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire OmniWorker home directory.",
    ...
    "hermes gateway install sets up OmniWorker as a system service (systemd/launchd).",
    ...
    "OmniWorker loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs OmniWorker as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'hermes dashboard --tui embeds the full OmniWorker TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'OMNIWORKER_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.hermes/plugins/ — trust-gated by design.',
