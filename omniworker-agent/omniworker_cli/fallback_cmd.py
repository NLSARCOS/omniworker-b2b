...
def _restore_auth_active_provider(value: Any) -> None:
    ...
    try:
        from flux-agent_cli.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def cmd_fallback_add(args) -> None:
    ...
    from flux-agent_cli.main import _require_tty, select_provider_and_model
