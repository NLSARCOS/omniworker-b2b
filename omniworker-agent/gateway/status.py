...
def _get_pid_path() -> Path:
    """Return the path to the gateway PID file, respecting OMNIWORKER_HOME."""
...
def _get_lock_dir() -> Path:
    ...
    override = os.getenv("OMNIWORKER_GATEWAY_LOCK_DIR")
    if override:
...
def _looks_like_gateway_process(pid: int) -> bool:
    """Return True when the live PID still looks like the OmniWorker gateway."""
...
def acquire_scoped_lock(scope: str, identity: str, metadata: Optional[dict[str, Any]] = None) -> tuple[bool, Optional[dict[str, Any]]]:
    ...
    at once (e.g. the same Telegram bot token across different OMNIWORKER_HOME dirs).
    """
