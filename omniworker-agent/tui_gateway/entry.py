...
# flux-agent modules.  flux-agent_cli sets OMNIWORKER_PYTHON_SRC_ROOT before spawning this
...
# ``flux-agent --tui``) imports cleanly there.  SIGBREAK (Windows' Ctrl+Break)
