...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. OmniWorker also honours OMNIWORKER_CA_BUNDLE (its own convention)
...
# Minimum context length required to run OmniWorker Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent OmniWorker from probing-down to
...
_URL_TO_PROVIDER: Dict[str, str] = {
    ...
    # (often 8K) makes it unusable for OmniWorker' system prompt, but mapping
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # OmniWorker grow conversations past the runtime limit and Ollama
