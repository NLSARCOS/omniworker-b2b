...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - omniworker_home (str): The active OMNIWORKER_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.omniworker``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "omniworker").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'omniworker memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], omniworker_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'omniworker memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``omniworker_home`` is the active OMNIWORKER_HOME directory path.
