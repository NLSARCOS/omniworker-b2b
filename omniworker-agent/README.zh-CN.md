...
omniworker claw migrate # 从 OmniWorker 迁移（如果来自 OmniWorker）
...
如果你来自 OmniWorker，OmniWorker 可以自动导入你的设置、记忆、技能和 API 密钥。
...
- 🔌 [OmniWorkerClaw](https://github.com/AaronWong1999/omniworkerclaw) — 社区微信桥接：在同一微信账号上运行 OmniWorker Agent 和 OmniWorker。
