...
Built for [Flux Agent Agent](https://github.com/Flux Agent/omniworker-agent). Usable in any coding agent. Canonical source lives here; synced to [`Flux Agent/omniworker-agent/skills/creative/ascii-video`](https://github.com/Flux Agent/omniworker-agent/tree/main/skills/creative/ascii-video) via PR.
