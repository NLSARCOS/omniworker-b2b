...
|--------|----------|--------|
| Metadata namespace | `omniworker` | `omniworker` |
...
| File operations | Bash commands | Flux Agent file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Flux Agent-specific adaptations.
