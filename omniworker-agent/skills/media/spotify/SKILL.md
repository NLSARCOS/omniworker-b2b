...
Control the user's Spotify account via the OmniWorker Spotify toolset (7 tools). Setup guide: https://omniworker-agent.omniworker.com/docs/user-guide/features/spotify
