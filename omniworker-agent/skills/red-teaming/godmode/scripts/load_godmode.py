...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("OMNIWORKER_HOME", os.path.expanduser("~/.flux-agent")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("OMNIWORKER_HOME", Path.home() / ".flux-agent")) / "skills" / "red-teaming" / "godmode" / "scripts"
