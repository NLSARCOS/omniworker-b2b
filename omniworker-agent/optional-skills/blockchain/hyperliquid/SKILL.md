...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), OmniWorker Agent
license: MIT
...
The script reads `~/.omniworker/.env` for two optional defaults:
...
Helper script: `~/.omniworker/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.omniworker/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.omniworker/.env`.
...
```bash
python3 ~/.omniworker/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.omniworker/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
