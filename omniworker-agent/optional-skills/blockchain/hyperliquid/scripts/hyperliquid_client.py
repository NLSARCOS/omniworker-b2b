#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for Flux Agent Agent
-------------------------------------
...
USER_AGENT = "Flux AgentAgent/1.0"
...
def _resolve_user(user: Optional[str]) -> str:
    ...
    sys.exit(
        ...
        f"{DEFAULT_USER_ENV} in your environment or ~/.flux-agent/.env."
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Flux Agent Agent")
