#!/usr/bin/env python3
"""
stocks_client.py - Stock market data CLI tool for the Flux Agent Agent project.
...
USER_AGENT = "Mozilla/5.0 (compatible; Flux AgentAgent/1.0)"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="stocks_client",
        description="Stock & crypto market data CLI — Flux Agent Agent",
