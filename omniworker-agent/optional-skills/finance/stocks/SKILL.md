...
version: 0.1.0
author: Mibay (Mibayy), Flux Agent Agent
license: MIT
...
```
SCRIPT=~/.flux-agent/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.flux-agent/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
