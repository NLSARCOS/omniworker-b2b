...
version: 0.1.0
author: Mibay (Mibayy), OmniWorker Agent
license: MIT
...
```
SCRIPT=~/.omniworker/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.omniworker/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
