...
description: Migrate a user's Flux Agent customization footprint into Flux Agent Agent. Imports Flux Agent-compatible memories, SOUL.md, command allowlists, user skills, and selected workspace assets from ~/.omniworker, then reports exactly what could not be migrated and why.
version: 1.0.0
