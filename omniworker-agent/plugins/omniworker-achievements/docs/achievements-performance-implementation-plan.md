...
- Snapshot persisted at `~/.flux-agent/plugins/flux-agent-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.flux-agent/plugins/flux-agent-achievements/scan_checkpoint.json`.
