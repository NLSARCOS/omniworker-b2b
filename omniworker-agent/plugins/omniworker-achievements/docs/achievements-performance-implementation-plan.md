# OmniWorker Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.omniworker/plugins/omniworker-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.omniworker/plugins/omniworker-achievements/scan_checkpoint.json`.
