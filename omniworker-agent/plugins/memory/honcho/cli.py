...
def cmd_peer(args) -> None:
    ...
    if user_name is None and ai_name is None and reasoning is None:
        ...
        print(f"  AI peer:     {ai}")
        print("    Flux Agent' identity in Honcho. Seed with 'omniworker honcho identity <file>'.")
...
def cmd_migrate(args) -> None:
    ...
    if user_files or agent_files:
        ...
        print("  No Flux Agent native memory files found in cwd or ~/.omniworker/.")
...
def register_cli(subparser) -> None:
    ...
    subs.add_parser(
        "migrate",
        help="Step-by-step migration guide from omniworker-honcho to Flux Agent Honcho",
    )
