...
# OMNIWORKER_* vars that change test behavior by being set. Unset all of these
# unconditionally — individual tests that need them set do so explicitly.
_OMNIWORKER_BEHAVIORAL_VARS = frozenset({
    "OMNIWORKER_YOLO_MODE",
    "OMNIWORKER_INTERACTIVE",
    "OMNIWORKER_QUIET",
    "OMNIWORKER_TOOL_PROGRESS",
    "OMNIWORKER_TOOL_PROGRESS_MODE",
    "OMNIWORKER_MAX_ITERATIONS",
    "OMNIWORKER_SESSION_PLATFORM",
    "OMNIWORKER_SESSION_CHAT_ID",
    "OMNIWORKER_SESSION_CHAT_NAME",
    "OMNIWORKER_SESSION_THREAD_ID",
    "OMNIWORKER_SESSION_SOURCE",
    "OMNIWORKER_SESSION_KEY",
    "OMNIWORKER_GATEWAY_SESSION",
    "OMNIWORKER_PLATFORM",
    "OMNIWORKER_MODEL",
    "OMNIWORKER_INFERENCE_MODEL",
    "OMNIWORKER_INFERENCE_PROVIDER",
    "OMNIWORKER_TUI_PROVIDER",
    "OMNIWORKER_MANAGED",
    "OMNIWORKER_DEV",
    "OMNIWORKER_CONTAINER",
    "OMNIWORKER_EPHEMERAL_SYSTEM_PROMPT",
    "OMNIWORKER_TIMEZONE",
    "OMNIWORKER_REDACT_SECRETS",
    "OMNIWORKER_BACKGROUND_NOTIFICATIONS",
    "OMNIWORKER_EXEC_ASK",
    ...
    "OMNIWORKER_KANBAN_LOGS_ROOT",
    "OMNIWORKER_KANBAN_TASK",
    "OMNIWORKER_KANBAN_WORKSPACE",
    "OMNIWORKER_TENANT",
    "TERMINAL_CWD",
    "TERMINAL_ENV",
...
def _hermetic_environment(tmp_path, monkeypatch):
    ...
    # 2. Blank behavioral OMNIWORKER_* vars that could change test semantics.
    for name in _OMNIWORKER_BEHAVIORAL_VARS:
        monkeypatch.delenv(name, raising=False)
