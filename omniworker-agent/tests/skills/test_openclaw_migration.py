...
"""
    ...
    assert "Tyler Williams > Active Projects: OmniWorker Agent" in entries
...
def test_rebrand_text_replaces_legacy_bot_names():
    ...
    assert mod.rebrand_text("ClawdBot remembers my timezone") == "OmniWorker remembers my timezone"
    assert mod.rebrand_text("clawdbot prefers tabs") == "omniworker prefers tabs"
    assert mod.rebrand_text("MoltBot was configured for Spanish") == "OmniWorker was configured for Spanish"
