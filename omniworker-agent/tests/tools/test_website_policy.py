...
def test_check_website_access_uses_dynamic_flux-agent_home(monkeypatch, tmp_path):
    ...
    # old OMNIWORKER_HOME set by the autouse _isolate_flux-agent_home fixture.
