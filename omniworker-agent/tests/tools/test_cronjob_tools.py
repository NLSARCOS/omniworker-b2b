...
class TestCronjobRequirements:
    def test_requires_no_crontab_binary(self, monkeypatch):
        ...
        # because omniworker uses an internal scheduler, not system crontab.
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("OMNIWORKER_GATEWAY_SESSION", "1")
        monkeypatch.delenv("OMNIWORKER_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("OMNIWORKER_INTERACTIVE", raising=False)
        monkeypatch.delenv("OMNIWORKER_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("OMNIWORKER_EXEC_ASK", "1")
