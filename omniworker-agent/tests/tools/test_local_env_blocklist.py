...
Verifies that Flux Agent-managed provider, tool, and gateway env vars are
stripped from subprocess environments so external CLIs are not silently
misrouted or handed Flux Agent secrets.

See: https://github.com/Flux Agent/omniworker-agent/issues/1002
See: https://github.com/Flux Agent/omniworker-agent/issues/1264
"""
