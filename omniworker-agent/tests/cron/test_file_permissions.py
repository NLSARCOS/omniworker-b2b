...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("omniworker_cli.config.get_config_path", return_value=config_path), \
             patch("omniworker_cli.config.ensure_omniworker_home"):
    ...
    def test_ensure_omniworker_home_sets_0700(self):
        home = Path(self.tmpdir) / ".omniworker"
        with patch("omniworker_cli.config.get_omniworker_home", return_value=home):
