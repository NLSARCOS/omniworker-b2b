"""Tests for the kanban CLI surface (omniworker_cli.kanban)."""
...
from omniworker_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from omniworker_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_run_slash_board_override_restores_prior_env(kanban_home, monkeypatch):
    ...
    monkeypatch.setenv("OMNIWORKER_KANBAN_BOARD", "beta")

    kc.run_slash("--board alpha list")

    assert os.environ.get("OMNIWORKER_KANBAN_BOARD") == "beta"
