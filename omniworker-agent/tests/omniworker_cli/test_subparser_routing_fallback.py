...
The main() function in omniworker_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `omniworker -c model`
...
def _build_parser():
    """Build a minimal replica of the omniworker top-level parser."""
