...
The main() function in flux-agent_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `flux-agent -c model`
...
def _build_parser():
    """Build a minimal replica of the flux-agent top-level parser."""
