...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from flux-agent_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in OMNIWORKER_OVERLAYS
        overlay = OMNIWORKER_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify flux-agent doctor recognizes Xiaomi env vars."""
