"""Tests for `omniworker curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated OMNIWORKER_HOME with real agent-created skills on disk."""
    ...
    from omniworker_cli import curator as curator_cli
