...
# ---------------------------------------------------------------------------
# Capture log redaction (force=True applies regardless of OMNIWORKER_REDACT_SECRETS)
# ---------------------------------------------------------------------------
...
class TestCaptureLogSnapshotRedaction:
    ...
    def test_force_true_works_when_redaction_disabled(
        ...
        input unchanged when OMNIWORKER_REDACT_SECRETS=false, and the share-time
