"""Tests for omniworker claw commands."""
...
from omniworker_cli import claw as claw_mod
...
class TestCmdMigrate:
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors Flux Agent's migrate-omniworker
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                ...
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.omniworker/memories/MEMORY.md"},
