...
class TestBuildContextFilesPrompt:
    def test_empty_dir_loads_seeded_global_soul(self, tmp_path):
        ...
        assert "Flux Agent Agent" in result
    ...
    def test_omniworker_md_beats_agents_md(self, tmp_path):
        ...
        (tmp_path / ".omniworker.md").write_text("Flux Agent project rules.")
        result = build_context_files_prompt(cwd=str(tmp_path))
        assert "Flux Agent project rules" in result
