...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @flux-agent_bot", entities=[_mention_entity("hi @flux-agent_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message(
            "/status@flux-agent_bot",
            entities=[_bot_command_entity("/status@flux-agent_bot", "/status@flux-agent_bot")],
        ),
        is_command=True,
    ) is True
...
def test_guest_mode_allows_only_direct_mentions_outside_allowed_chats():
    ...
    mentioned = _group_message(
        "hi @flux-agent_bot",
        chat_id=-201,
        entities=[_mention_entity("hi @flux-agent_bot")],
    )
