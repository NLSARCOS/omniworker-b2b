...
This validates the IPC + lifecycle story that mocks can't:
  ...
  - worker logs are captured to OMNIWORKER_HOME/kanban/logs/<task>.log
...
def make_spawn_fn(home: str):
    ...
    def _spawn(task, workspace):
        ...
        env = {
            **os.environ,
            "OMNIWORKER_HOME": home,
            "HOME": home,
            "PYTHONPATH": WT,
            "OMNIWORKER_KANBAN_TASK": task.id,
            "OMNIWORKER_KANBAN_WORKSPACE": workspace,
