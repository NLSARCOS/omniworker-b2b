export default {
  ...
  noMemoriesYet: "No memories yet. OmniWorker will save important facts as you chat.",
  ...
  userProfileHint: "Tell OmniWorker about yourself — name, role, preferences, communication style.",
  providersHint: "Pluggable memory providers give OmniWorker advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
