export default {
  ...
  dividerOr: "or",
  connectRemote: "Connect to Remote OmniWorker",
  connectRemoteTitle: "Connect to Remote OmniWorker",
  connectRemoteSubtitle: "Enter the URL of a running OmniWorker API server.",
