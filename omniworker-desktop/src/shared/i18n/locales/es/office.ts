export default {
  ...
  setupDesc1: "Claw3D es un entorno de visualización 3D para tus agentes de OmniWorker. Te permite ver a tus agentes trabajando en un espacio de oficina interactivo.",
