export default {
  ...
  dividerOr: "o",
  connectRemote: "Conectarse a Flux Agent remoto",
  connectRemoteTitle: "Conectarse a Flux Agent remoto",
  connectRemoteSubtitle:
    "Introduce la URL de un servidor de API de Flux Agent en ejecución.",
