export default {
  title: "欢迎使用 Flux Agent By Simplex",
  ...
  dividerOr: "或",
  connectRemote: "连接远程 Flux Agent By Simplex",
  connectRemoteTitle: "连接远程 Flux Agent By Simplex",
  connectRemoteSubtitle: "输入运行中的 Flux Agent By Simplex API 服务器的 URL。",
