export default {
  ...
  noMemoriesYet: "まだメモリがありません。OmniWorker はチャットを通じて重要な事実を保存します。",
  noMemoryEntries: "メモリエントリがまだありません。",
  noToolsetsFound: "ツールセットが見つかりません。",
  addManuallyHint: "上のボタンから手動でメモリを追加することもできます。",
  userProfileHint: "あなた自身について OmniWorker に教えてください — 名前、役割、好み、コミュニケーションスタイルなど。",
  providersHint: "プラガブルなメモリプロバイダは OmniWorker に高度な長期記憶を与えます。組み込みメモリ（上）は選択したプロバイダと並行して常時動作します。",
