export default {
  ...
  updateSuccess: "Flux Agent By Simplex atualizado com sucesso.",
  ...
  poolHint:
    "Adicione várias chaves de API para o mesmo provedor para rotação automática e balanceamento de carga. O OmniWorker alternará entre elas.",
  add: "Adicionar",
  remove: "Remover",
  keyLabel: "Chave",
  empty: "(vazio)",
  dataSection: "Dados",
  dataHint:
    "Exporte ou importe sua configuração do OmniWorker, sessões, habilidades e memória.",
  ...
  migrationDetected: "Instalação do Flux Agent By Simplex Detectada",
  migrationDesc:
  ...
  migrating: "Migrando...",
  migrateToOmniWorker: "Migrar para o Flux Agent By Simplex",
  skip: "Pular",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando o Flux Agent By Simplex instalado neste dispositivo",
  modeRemoteHint:
    "Conectar a um servidor da API do OmniWorker na sua rede ou nuvem",
  remoteUrl: "URL Remota",
  remoteUrlHint:
    "A URL do servidor da API do OmniWorker (deve expor /health e /v1/chat/completions)",
  ...
  serverConfigHint:
    "Você está conectado a um servidor remoto do Flux Agent By Simplex. A seleção de modelos, as chaves de API dos provedores e as credenciais são gerenciadas no host remoto em <code>~/.omniworker/.env</code> e <code>config.yaml</code>. Edite-os lá e reinicie o servidor.",
  connectionMode: "Modo",
