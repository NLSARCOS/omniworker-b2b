export default {
  ...
  updateSuccess: "OmniWorker atualizado com sucesso.",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando o OmniWorker instalado neste dispositivo",
  modeRemoteHint:
  ...
  serverConfigHint:
    "Você está conectado a um servidor remoto do OmniWorker. A seleção de modelos, as chaves de API dos provedores e as credenciais são gerenciadas no host remoto em <code>~/.omniworker/.env</code> e <code>config.yaml</code>. Edite-os lá e reinicie o servidor.",
  connectionMode: "Modo",
