export default {
  ...
  noMemoriesYet: "Nenhuma memória ainda. O OmniWorker salvará fatos importantes conforme vocês conversam.",
  ...
  userProfileHint: "Conte ao OmniWorker sobre você — nome, cargo, preferências, estilo de comunicação.",
  providersHint: "Provedores de memória plugáveis dão ao OmniWorker uma memória de longo prazo avançada. A memória integrada (acima) está sempre ativa ao lado do provedor selecionado.",
